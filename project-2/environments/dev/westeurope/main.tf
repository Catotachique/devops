...
module "storageaccount" {
  source = "C:/Users/felip/OneDrive/Documentos/tier0/data-enginner/project-2/modules/azure/storageaccounts"
...
module "datafactory" {
  source = "C:/Users/felip/OneDrive/Documentos/tier0/data-enginner/project-2/modules/azure/datafactory"

  instances = {
    df-de-project-2 = {
      name                = "df-de-project-2"
...
module "databasesql" {
  source = "C:/Users/felip/OneDrive/Documentos/tier0/data-enginner/project-2/modules/azure/databasesql"

  databases = {
    dbsql-de-project-2 = {
      name                = "dbsql-de-project-2"
      resource_group_name = module.resourcegroups.resource_group_name_data_storage
    }
  }
}
